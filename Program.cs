...
using GreenStoreWeb.Services.Implementation;
...
builder.Services.AddDbContext<UserDetailsContext>(
    option =>
    {
        option.UseNpgsql(builder.Configuration.GetConnectionString("sqlconnection"));
    }
    );
